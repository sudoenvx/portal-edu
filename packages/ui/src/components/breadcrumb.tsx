              ...
              {isCurrent || !item.href ? (
                <span
                  ...
                  className={cn(
                    ...
                    isCurrent ? 'font-bold text-primary-dark' : 'text-text-muted',
                  )}
                >
                ...
                <a
                  href={item.href}
                  className="flex min-w-0 items-center gap-1.5 truncate text-text-muted transition-colors hover:text-secondary-dark focus-visible:rounded-sm focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
                >
