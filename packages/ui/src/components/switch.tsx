  ...
  return (
    ...
    >
      <span
        ...
        className={cn(
          'pointer-events-none absolute top-[3px] left-[3px] rounded-xs bg-surface shadow-card transition-transform duration-150',
          THUMB_SIZE[size],
  ...
  return (
    <label
      ...
      className={cn(
        ...
        checked ? 'bg-primary-subtle' : 'bg-neutral-100 hover:bg-neutral-200',
