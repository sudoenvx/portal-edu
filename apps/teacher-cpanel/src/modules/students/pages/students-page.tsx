    ...
    () => [
      {
        ...
        render: (student) => (
          <div className="flex items-center gap-2.5">
            <span className="flex h-6 w-6 items-center justify-center bg-neutral-200 text-text">
              <UserRound size={13} />
            </span>
            <div className="min-w-0">
              <Link
                to={`/students/${student.id}`}
                className="truncate text-[13px] font-bold text-primary hover:text-primary-hover"
              >
                {student.fullName}
              </Link>
            </div>
      ...
      },
      {
        ...
        cellClassName: 'font-inter text-[11px] text-text-muted',
        render: (student) => (
      ...
      { header: 'المرحلة', accessor: 'stageName', cellClassName: 'text-[11px] text-text-muted' },
      {
        header: 'الحالة',
        render: (student) => {
      ...
      <DataTable
        ...
        pagination={
          <Pagination
            ...
            showPerPageSelect
            onPerPageChange={() => {
              // setPage(pp === 10 ? 1 : 1) // Reset to page 1 when changing perPage
            }}
          />
        }
      />
