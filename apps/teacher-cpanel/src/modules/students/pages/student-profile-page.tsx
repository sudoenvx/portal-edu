...
import { Badge, Body, Breadcrumb, Button, Card, PageHeader, Title } from '@portal-edu/ui'
          ...
          <Card bodyClassName="p-4">
            ...
            <div className="mt-4 pt-4">
              {qrUrl ? (
                ...
                <div className="flex h-40 items-center justify-center bg-canvas text-center text-[11px] text-text-muted">
