    ...
    <div className="flex flex-col max-w-5xl mx-auto gap-6 animate-in fade-in duration-300 pb-10">
     ...
     />
      ...
      <PageHeader
        ...
        className="sticky top-13"
        actions={
          <>
            <Button color="neutral" size="sm" onClick={() => navigate(-1)} disabled={isSaving}>
              إلغاء ورجوع
            </Button>
          ...
          {activeTab === 'billing' && (
            <div className="flex flex-col gap-5 animate-in fade-in slide-in-from-bottom-2">
              ...
              <Card
                ...
                title={
                  <div className="flex items-center gap-2">
                    <ShieldAlert size={14} className="text-text" />
                    <span className="text-text">سياسة الحسابات المتأخرة والعقوبات</span>
                  </div>
                }
              >
