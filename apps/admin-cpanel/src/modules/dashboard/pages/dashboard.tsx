...
import { StatisticCard, DataTable, Badge, Card, IconButton, Button } from '@portal-edu/ui'
      ...
      render: () => {
        return (
          <div className="flex items-center gap-1 justify-end">
            <IconButton aria-label="الإعدادات" icon={<Settings />}  size="sm" />
          </div>
        )
      }
    }
    ...
    <div className="flex flex-col gap-4 animate-in fade-in duration-300 pb-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        >
          ...
          <div className="flex-1 flex items-end justify-between gap-2 sm:gap-4 pt-4 border-b border-border px-2 pb-1 relative min-h-[220px]">
            {/* خطوط الشبكة */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <Card className="rounded-sm border-danger/30 bg-danger-subtle" bodyClassName="p-4 flex flex-col justify-between relative overflow-hidden group cursor-pointer">
