...
/**
 * Drop-in Express error-handling middleware. Register it last, after all routes:
 *   app.use(apiErrorHandler);
 * Works with both `next(err)` and thrown errors inside async handlers
 * (assuming you're on Express 5, or wrapping async routes yourself on Express 4).
 */
